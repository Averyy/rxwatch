...
const sidebarMenuButtonVariants = cva(
  "ring-sidebar-ring bg-transparent hover:bg-primary/10 hover:text-primary active:bg-primary/15 active:text-primary data-[active=true]:bg-primary/10 data-[active=true]:text-primary data-[active=true]:font-medium data-open:hover:bg-primary/10 data-open:hover:text-primary gap-2 rounded-md p-2 text-left text-sm transition-all duration-150 group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! focus-visible:ring-2 peer/menu-button flex w-full items-center overflow-hidden outline-hidden disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default: "hover:bg-primary/10 hover:text-primary",
        outline: "bg-background hover:bg-primary/10 hover:text-primary shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:shadow-[0_0_0_1px_hsl(var(--primary))]",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
